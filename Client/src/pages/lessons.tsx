...
import { uploadIntroVideo } from "../store/features/courseSlice";
import { addLessons } from "../store/features/lessonSlice";
...
type LessonFormData = z.infer<typeof courseLessonsSchema>;
