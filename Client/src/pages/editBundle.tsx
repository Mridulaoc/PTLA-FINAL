...
const BundleEdit = () => {
  ...
  useEffect(() => {
    if (currentBundle) {
      ...
      setValue("accessType", currentBundle.accessType || "lifetime");
      if (
        currentBundle.accessType === "limited" &&
        currentBundle.accessPeriodDays
      ) {
        setValue("accessPeriodDays", currentBundle.accessPeriodDays);
      }
    }
